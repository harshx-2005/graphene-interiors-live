...
export async function POST(request: Request) {
  try {
    ...
    if (formType === "quote") {
      ...
      emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #C7A16B; border-radius: 12px; background-color: #F8F8F8;">
          <h2 style="color: #111827; border-bottom: 2px solid #C7A16B; padding-bottom: 10px; font-family: Georgia, serif;">Graphene Interiors Ltd — New Quote Lead</h2>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
            ...
            <tr style="background-color: #eee;"><td style="padding: 10px; font-weight: bold;">Preferred Contact:</td><td style="padding: 10px; text-transform: uppercase; font-weight: bold; color: #C7A16B;">${contactMethod}</td></tr>
          </table>
          <div style="margin-top: 20px; padding: 15px; background-color: #fff; border-left: 4px solid #C7A16B;">
      ...
      emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #C7A16B; border-radius: 12px; background-color: #F8F8F8;">
          <h2 style="color: #111827; border-bottom: 2px solid #C7A16B; padding-bottom: 10px; font-family: Georgia, serif;">Graphene Interiors Ltd — Consultation Lead</h2>
          <p style="font-size: 16px; color: #1F2937;">You have received a new consultation request from the website exit-intent modal.</p>
          <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
            <tr style="background-color: #eee;"><td style="padding: 10px; font-weight: bold; width: 180px;">Client Name:</td><td style="padding: 10px;">${name}</td></tr>
            <tr><td style="padding: 10px; font-weight: bold;">Phone:</td><td style="padding: 10px;"><a href="tel:${phone}">${phone}</a></td></tr>
            <tr style="background-color: #eee;"><td style="padding: 10px; font-weight: bold;">Email:</td><td style="padding: 10px;"><a href="mailto:${email}">${email}</a></td></tr>
            <tr><td style="padding: 10px; font-weight: bold;">Preferred Date:</td><td style="padding: 10px; font-weight: bold; color: #C7A16B;">${preferredDate}</td></tr>
